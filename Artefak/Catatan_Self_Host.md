...
1.  **Lexer/Parser Debugging:** Kompiler melaporkan "Gagal Lexing" pada file sederhana (`tulis`). Diagnosa kini dimungkinkan berkat perbaikan String Methods. Terindikasi masalah pada pengenalan karakter di Lexer saat berjalan di Rust VM.
