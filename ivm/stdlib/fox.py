...
def _create_fox_builtin(api_func):
    def builtin_wrapper(args):
        ...
        if len(args) < 2:
            raise TypeError(f"Fungsi {api_func.__name__} butuh minimal nama dan fungsi")
        ...
        return _run_sync(getattr(fox_api, api_func)(nama, _wrapper, *extra_args))
